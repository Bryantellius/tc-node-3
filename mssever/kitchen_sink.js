...
var nine = 5 + 4;
var greater = 5 > 4;
var two_thirty_five = 231 + 4;
nine = 5 + 4; // repeat from before
...
[['Charles', 21], ['Abby', 27], ['James', 18], ['John', 17]].forEach(person => {
  checkAge(person[0], person[1]);
});
...
var favorite_vegetables = ['broccoli', 'corn', 'potatoes'];
favorite_vegetables.forEach(vegetable => {
